...
- [x] **Task 1: pure tier rules** (`internal/camping/tiers.go`,
...
- [x] **Task 2: walking's Rested tier** (`modules/walking`: buff
...
- [x] **Task 3: camping config and seams** (`modules/camping/inn.go`).
...
- [x] **Task 4: camp Rested grant and exclusivity** (`modules/camping`).
...
- [x] **Task 5: owed grants** (`modules/camping`). Tests first:
...
- [x] **Task 6: spawn normalization and buff 16** (`modules/camping`,
...
- [x] **Task 7: wiring tests through real entry points**
