...
- [x] **Task 1: level loss** (`internal/characters/character.go`,
  ...
  `LevelUp` rule.
- [x] **Task 2: death domain** (`internal/death/death.go`, `death_test.go`).
...
- [x] **Task 3: the `suicide` branch** (`internal/usercommands/suicide.go`,
...
- [x] **Task 4: travel abandon** (`internal/expedition`,
...
- [x] **Task 5: camp abandon** (`internal/camping`, `modules/camping`).
  ...
  Then the seam and the module method.
- [x] **Task 6: company relocation** (`internal/company/provider.go`,
...
- [x] **Task 7: death module** (`modules/death`). Tests first:
...
- [x] **Task 8: content** (`_datafiles/world/default`). Tests first:
  ...
  config overlay.
- [x] **Task 9: wiring** (`modules/death/wiring_test.go`). Through
...
- [x] **Task 10: docs and verification.** Config comments, module
