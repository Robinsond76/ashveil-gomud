...
- [ ] **`internal/market`: `Rumors`, `PickRumors`** (`rumor.go`).
  ...
  - Then implement.
- [ ] **`modules/market`: durable news snapshot.**
...
- [ ] **`modules/market`: `rumors`/`rumours` command.**
...
- [ ] **Config overlay:** `RumorRoomTag`, `RumorRefreshRounds`,
