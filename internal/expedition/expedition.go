...
// AbandonProvider is implemented by modules/expedition (Phase 25a).
// AbandonForDeath ends a dead leader's journey, whatever its state, without
// moving anyone, and saves that at once. An error means the session is
// still there.
...
// AbandonForDeath ends a dead leader's journey. Without a provider there is
// no journey to end.
